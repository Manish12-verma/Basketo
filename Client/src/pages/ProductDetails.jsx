  ...
  return  product && (
    <div className="mt-12">
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                               ...
                               <img src={ i<4 ? assets.star_icon: assets.star_dull_icon} alt="rating" className='md:w-4 w-3.5 '/>
            ...
            <div className='flex flex-col items-center mt-20'>
                       <div className='flec flex-col items-center w-max  '>
                        <p className='text-3xl font-medium'>Related Products</p>
                        <div className='w-20 h-0.5 bg-primary rounded-full mt-2 '></div> {/* underline the text */}
                       </div>
